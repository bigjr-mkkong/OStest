...
#define KBSTATUS_IBF    0x02 //Input Buffer Filled
#define KBSTATUS_OBF    0x01 //Output Buffer Filled
...
/*
buffer receive scan code from p_head
sent out scan code (to get_scancode()) from p_tail
*/
struct keyboard_input_buf{
